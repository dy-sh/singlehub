...
NodesEngine.prototype.getSupportedTypes = function () {
...
NodesEngine.prototype.clear = function () {
	this.stop();
...
NodesEngine.prototype.attachCanvas = function (graphcanvas) {
...
NodesEngine.prototype.detachCanvas = function (graphcanvas) {
	if (!this.list_of_graphcanvas)
		return;
...
NodesEngine.prototype.start = function (interval) {
...
NodesEngine.prototype.stop = function () {
...
NodesEngine.prototype.runStep = function (num) {
	num = num || 1;
...
NodesEngine.prototype.getTime = function () {
...
NodesEngine.prototype.getFixedTime = function () {
...
NodesEngine.prototype.getElapsedTime = function () {
...
NodesEngine.prototype.sendEventToAllNodes = function (eventname, params) {
...
NodesEngine.prototype.sendActionToCanvas = function (action, params) {
	if (!this.list_of_graphcanvas)
		return;
...
NodesEngine.prototype.add = function (node, skip_compute_order) {
...
NodesEngine.prototype.remove = function (node) {
...
NodesEngine.prototype.getNodeById = function (id) {
...
NodesEngine.prototype.findNodesByClass = function (classObject) {
	var r = [];
	for (var i = 0, l = this._nodes.length; i < l; ++i)
...
NodesEngine.prototype.findNodesByType = function (type) {
...
NodesEngine.prototype.findNodesByTitle = function (title) {
	var result = [];
	for (var i = 0, l = this._nodes.length; i < l; ++i)
...
NodesEngine.prototype.getNodeOnPos = function (x, y, nodes_list) {
...
NodesEngine.prototype.addGlobalInput = function (name, type, value) {
...
NodesEngine.prototype.setGlobalInputData = function (name, data) {
...
//assign a data to the global input
NodesEngine.prototype.getGlobalInputData = function (name) {
	var input = this.global_inputs[name];
	if (!input)
		return null;
	return input.value;
...
NodesEngine.prototype.renameGlobalInput = function (old_name, name) {
	if (name == old_name)
		return;
...
NodesEngine.prototype.changeGlobalInputType = function (name, type) {
	if (!this.global_inputs[name])
		return false;
...
NodesEngine.prototype.removeGlobalInput = function (name) {
	if (!this.global_inputs[name])
		return false;
...
NodesEngine.prototype.addGlobalOutput = function (name, type, value) {
...
NodesEngine.prototype.setGlobalOutputData = function (name, value) {
...
//assign a data to the global input
NodesEngine.prototype.getGlobalOutputData = function (name) {
	var output = this.global_outputs[name];
	if (!output)
		return null;
	return output.value;
...
NodesEngine.prototype.renameGlobalOutput = function (old_name, name) {
...
NodesEngine.prototype.changeGlobalOutputType = function (name, type) {
	if (!this.global_outputs[name])
		return false;
...
NodesEngine.prototype.removeGlobalOutput = function (name) {
	if (!this.global_outputs[name])
		return false;
...
NodesEngine.prototype.setInputData = function (name, value) {
...
NodesEngine.prototype.getOutputData = function (name) {
...
NodesEngine.prototype.triggerInput = function (name, value) {
	var nodes = this.findNodesByName(name);
	for (var i = 0; i < nodes.length; ++i)
		nodes[i].onTrigger(value);
}

NodesEngine.prototype.setCallback = function (name, func) {
	var nodes = this.findNodesByName(name);
	for (var i = 0; i < nodes.length; ++i)
...
NodesEngine.prototype.connectionChange = function (node) {
	this.updateExecutionOrder();
...
NodesEngine.prototype.isLive = function () {
	if (!this.list_of_graphcanvas)
		return false;
...
NodesEngine.prototype.change = function () {
...
NodesEngine.prototype.setDirtyCanvas = function (fg, bg) {
 ...
 */
NodesEngine.prototype.serialize = function () {
	var nodes_info = [];
	for (var i = 0, l = this._nodes.length; i < l; ++i)
 ...
 */
NodesEngine.prototype.configure = function (data, keep_old) {
	if (!keep_old)
		this.clear();
