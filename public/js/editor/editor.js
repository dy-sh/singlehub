...
var Editor = (function () {
    function Editor() {
        ...
        //create renderer
        var renderer = this.renderer = new renderer_1.Renderer(canvas, this.rootContainer, theme);
    ...
    Editor.prototype.updateContainersNavigation = function () {
        ...
        //update split button
        var split = $("#split-button").attr("href").startsWith("/editor/split/");
        if (split)
        ...
        if (this.renderer._containers_stack
            ...
            for (var cont = 1; cont < cont_count; cont++) {
                var cont_name_1 = this.renderer._containers_stack[cont].name;
            ...
            var cont_name = this.renderer.container.name;
