...
var Nodes = (function () {
     ...
     */
    Nodes.registerNodeType = function (type, node_class) {
     ...
     * @param func
     */
    Nodes.addNodeMethod = function (name, func) {
     ...
     */
    Nodes.createNode = function (type, title, options) {
        var base_class = this.nodes_types[type];
        if (!base_class) {
     ...
     */
    Nodes.getNodeType = function (type) {
     ...
     */
    Nodes.getNodeTypesInCategory = function (category) {
        var r = [];
        for (var i in this.nodes_types)
            if (category == "") {
     ...
     */
    Nodes.getNodeTypesCategories = function () {
        var categories = { "": 1 };
        for (var i in this.nodes_types)
     ...
     */
    Nodes.reloadNodes = function (folder_wildcard) {
